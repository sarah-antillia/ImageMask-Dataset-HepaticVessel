...
if __name__ == "__main__":
  try:
    images_dir = "./HepaticVessel-master/train/images/"
    masks_dir  = "./HepaticVessel-master/train/masks/"
    output_dir = "./HepaticVessel-ImageMask-Dataset-V1/"
